...
import com.store.config.audit.AuditEventConverter;
import com.store.domain.PersistentAuditEvent;
...
import static com.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
